...
const ENRICHMENT = {
  NVDA: { exchange: 'NASDAQ', fund: { mcap: '2.19T', pe: 68.4, eps: 13.02, div: '0.04%', beta: 1.66, peg: 1.22 }, analyst: { buy: 38, hold: 4, sell: 1, consensus: 'Strong Buy', target: 1020 }, ai: { score: 82, signal: 'Buy', confidence: 0.74, target: 980 }, news: [{ src: 'Market Wire', time: '12m', head: 'NVIDIA expands Blackwell shipments amid record data-center demand' }, { src: 'Stratos Feed', time: '1h', head: 'Analysts raise FY26 targets after sovereign AI deals in EMEA' }, { src: 'Tech Brief', time: '5h', head: 'Supply constraints ease as TSMC ramps CoWoS capacity 2.4× YoY' }] },
